...
namespace DataServiceTest.Models.Repositories
{
	...
	public partial class WebCustomerFeedbackRepository : BaseRepository<WebCustomerFeedback, int>, IWebCustomerFeedbackRepository
	{
		...
		public override async Task<WebCustomerFeedback> AddAsync(WebCustomerFeedback entity)
		{
			entity.Active = true;
			entity = context.WebCustomerFeedbacks.Add(entity);
			if (AutoSave)
		...
		public override WebCustomerFeedback Delete(WebCustomerFeedback entity)
		{
		...
		public override async Task<WebCustomerFeedback> DeleteAsync(WebCustomerFeedback entity)
		{
			context.WebCustomerFeedbacks.Attach(entity);
			entity = context.WebCustomerFeedbacks.Remove(entity);
			if (AutoSave)
		...
		public override WebCustomerFeedback Delete(int key)
		{
		...
		public override async Task<WebCustomerFeedback> DeleteAsync(int key)
		{
			var entity = FindById(key);
			if (entity!=null)
				entity = context.WebCustomerFeedbacks.Remove(entity);
		...
		public override async Task<WebCustomerFeedback> UpdateAsync(WebCustomerFeedback entity)
		{
			entity = context.WebCustomerFeedbacks.Attach(entity);
			context.Entry(entity).State = EntityState.Modified;
			if (AutoSave)
