...
namespace DataServiceTest.Models.Repositories
{
	...
	public partial class DayModeRepository : BaseRepository<DayMode, int>, IDayModeRepository
	{
		...
		public override async Task<DayMode> AddAsync(DayMode entity)
		{
			entity.Active = true;
			entity = context.DayModes.Add(entity);
			if (AutoSave)
		...
		public override DayMode Delete(DayMode entity)
		{
		...
		public override async Task<DayMode> DeleteAsync(DayMode entity)
		{
			context.DayModes.Attach(entity);
			entity = context.DayModes.Remove(entity);
			if (AutoSave)
		...
		public override DayMode Delete(int key)
		{
		...
		public override async Task<DayMode> DeleteAsync(int key)
		{
			var entity = FindById(key);
			if (entity!=null)
				entity = context.DayModes.Remove(entity);
		...
		public override async Task<DayMode> UpdateAsync(DayMode entity)
		{
			entity = context.DayModes.Attach(entity);
			context.Entry(entity).State = EntityState.Modified;
			if (AutoSave)
