...
namespace DataServiceTest.Models.Repositories
{
	...
	public partial class WardRepository : BaseRepository<Ward, int>, IWardRepository
	{
		...
		public override async Task<Ward> AddAsync(Ward entity)
		{
		...
		public override Ward Delete(Ward entity)
		{
		...
		public override async Task<Ward> DeleteAsync(Ward entity)
		{
			context.Wards.Attach(entity);
			entity = context.Wards.Remove(entity);
			if (AutoSave)
		...
		public override Ward Delete(int key)
		{
		...
		public override async Task<Ward> DeleteAsync(int key)
		{
			var entity = FindById(key);
			if (entity!=null)
				entity = context.Wards.Remove(entity);
		...
		public override async Task<Ward> UpdateAsync(Ward entity)
		{
			entity = context.Wards.Attach(entity);
			context.Entry(entity).State = EntityState.Modified;
			if (AutoSave)
