...
namespace DataServiceTest.Models.Repositories
{
	...
	public partial class PaySlipTemplateRepository : BaseRepository<PaySlipTemplate, int>, IPaySlipTemplateRepository
	{
		...
		public override async Task<PaySlipTemplate> AddAsync(PaySlipTemplate entity)
		{
			entity.Active = true;
			entity = context.PaySlipTemplates.Add(entity);
			if (AutoSave)
		...
		public override PaySlipTemplate Delete(PaySlipTemplate entity)
		{
		...
		public override async Task<PaySlipTemplate> DeleteAsync(PaySlipTemplate entity)
		{
			context.PaySlipTemplates.Attach(entity);
			entity = context.PaySlipTemplates.Remove(entity);
			if (AutoSave)
		...
		public override PaySlipTemplate Delete(int key)
		{
		...
		public override async Task<PaySlipTemplate> DeleteAsync(int key)
		{
			var entity = FindById(key);
			if (entity!=null)
				entity = context.PaySlipTemplates.Remove(entity);
		...
		public override async Task<PaySlipTemplate> UpdateAsync(PaySlipTemplate entity)
		{
			entity = context.PaySlipTemplates.Attach(entity);
			context.Entry(entity).State = EntityState.Modified;
			if (AutoSave)
