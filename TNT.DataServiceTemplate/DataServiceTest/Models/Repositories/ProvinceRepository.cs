...
namespace DataServiceTest.Models.Repositories
{
	...
	public partial class ProvinceRepository : BaseRepository<Province, int>, IProvinceRepository
	{
		...
		public override async Task<Province> AddAsync(Province entity)
		{
		...
		public override Province Delete(Province entity)
		{
		...
		public override async Task<Province> DeleteAsync(Province entity)
		{
			context.Provinces.Attach(entity);
			entity = context.Provinces.Remove(entity);
			if (AutoSave)
		...
		public override Province Delete(int key)
		{
		...
		public override async Task<Province> DeleteAsync(int key)
		{
			var entity = FindById(key);
			if (entity!=null)
				entity = context.Provinces.Remove(entity);
		...
		public override async Task<Province> UpdateAsync(Province entity)
		{
			entity = context.Provinces.Attach(entity);
			context.Entry(entity).State = EntityState.Modified;
			if (AutoSave)
