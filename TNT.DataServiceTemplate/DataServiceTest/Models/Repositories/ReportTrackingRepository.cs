...
namespace DataServiceTest.Models.Repositories
{
	...
	public partial class ReportTrackingRepository : BaseRepository<ReportTracking, int>, IReportTrackingRepository
	{
		...
		public override async Task<ReportTracking> AddAsync(ReportTracking entity)
		{
		...
		public override ReportTracking Delete(ReportTracking entity)
		{
		...
		public override async Task<ReportTracking> DeleteAsync(ReportTracking entity)
		{
			context.ReportTrackings.Attach(entity);
			entity = context.ReportTrackings.Remove(entity);
			if (AutoSave)
		...
		public override ReportTracking Delete(int key)
		{
		...
		public override async Task<ReportTracking> DeleteAsync(int key)
		{
			var entity = FindById(key);
			if (entity!=null)
				entity = context.ReportTrackings.Remove(entity);
		...
		public override async Task<ReportTracking> UpdateAsync(ReportTracking entity)
		{
			entity = context.ReportTrackings.Attach(entity);
			context.Entry(entity).State = EntityState.Modified;
			if (AutoSave)
