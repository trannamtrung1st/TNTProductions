...
namespace DataServiceTest.Models.Repositories
{
	...
	public partial class CostCategoryRepository : BaseRepository<CostCategory, int>, ICostCategoryRepository
	{
		...
		public override async Task<CostCategory> AddAsync(CostCategory entity)
		{
			entity.Active = true;
			entity = context.CostCategories.Add(entity);
			if (AutoSave)
		...
		public override CostCategory Delete(CostCategory entity)
		{
		...
		public override async Task<CostCategory> DeleteAsync(CostCategory entity)
		{
			context.CostCategories.Attach(entity);
			entity = context.CostCategories.Remove(entity);
			if (AutoSave)
		...
		public override CostCategory Delete(int key)
		{
		...
		public override async Task<CostCategory> DeleteAsync(int key)
		{
			var entity = FindById(key);
			if (entity!=null)
				entity = context.CostCategories.Remove(entity);
		...
		public override async Task<CostCategory> UpdateAsync(CostCategory entity)
		{
			entity = context.CostCategories.Attach(entity);
			context.Entry(entity).State = EntityState.Modified;
			if (AutoSave)
