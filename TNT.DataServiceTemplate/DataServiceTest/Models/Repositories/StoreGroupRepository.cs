...
namespace DataServiceTest.Models.Repositories
{
	...
	public partial class StoreGroupRepository : BaseRepository<StoreGroup, int>, IStoreGroupRepository
	{
		...
		public override async Task<StoreGroup> AddAsync(StoreGroup entity)
		{
		...
		public override StoreGroup Delete(StoreGroup entity)
		{
		...
		public override async Task<StoreGroup> DeleteAsync(StoreGroup entity)
		{
			context.StoreGroups.Attach(entity);
			entity = context.StoreGroups.Remove(entity);
			if (AutoSave)
		...
		public override StoreGroup Delete(int key)
		{
		...
		public override async Task<StoreGroup> DeleteAsync(int key)
		{
			var entity = FindById(key);
			if (entity!=null)
				entity = context.StoreGroups.Remove(entity);
		...
		public override async Task<StoreGroup> UpdateAsync(StoreGroup entity)
		{
			entity = context.StoreGroups.Attach(entity);
			context.Entry(entity).State = EntityState.Modified;
			if (AutoSave)
