...
namespace DataServiceTest.Models.Repositories
{
	...
	public partial class InventoryDateReportRepository : BaseRepository<InventoryDateReport, int>, IInventoryDateReportRepository
	{
		...
		public override async Task<InventoryDateReport> AddAsync(InventoryDateReport entity)
		{
		...
		public override InventoryDateReport Delete(InventoryDateReport entity)
		{
		...
		public override async Task<InventoryDateReport> DeleteAsync(InventoryDateReport entity)
		{
			context.InventoryDateReports.Attach(entity);
			entity = context.InventoryDateReports.Remove(entity);
			if (AutoSave)
		...
		public override InventoryDateReport Delete(int key)
		{
		...
		public override async Task<InventoryDateReport> DeleteAsync(int key)
		{
			var entity = FindById(key);
			if (entity!=null)
				entity = context.InventoryDateReports.Remove(entity);
		...
		public override async Task<InventoryDateReport> UpdateAsync(InventoryDateReport entity)
		{
			entity = context.InventoryDateReports.Attach(entity);
			context.Entry(entity).State = EntityState.Modified;
			if (AutoSave)
