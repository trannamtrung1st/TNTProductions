...
namespace DataServiceTest.Models.Repositories
{
	...
	public partial class PayrollPeriodRepository : BaseRepository<PayrollPeriod, int>, IPayrollPeriodRepository
	{
		...
		public override async Task<PayrollPeriod> AddAsync(PayrollPeriod entity)
		{
		...
		public override PayrollPeriod Delete(PayrollPeriod entity)
		{
		...
		public override async Task<PayrollPeriod> DeleteAsync(PayrollPeriod entity)
		{
			context.PayrollPeriods.Attach(entity);
			entity = context.PayrollPeriods.Remove(entity);
			if (AutoSave)
		...
		public override PayrollPeriod Delete(int key)
		{
		...
		public override async Task<PayrollPeriod> DeleteAsync(int key)
		{
			var entity = FindById(key);
			if (entity!=null)
				entity = context.PayrollPeriods.Remove(entity);
		...
		public override async Task<PayrollPeriod> UpdateAsync(PayrollPeriod entity)
		{
			entity = context.PayrollPeriods.Attach(entity);
			context.Entry(entity).State = EntityState.Modified;
			if (AutoSave)
