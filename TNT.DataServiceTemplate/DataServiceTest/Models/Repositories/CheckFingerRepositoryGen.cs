...
namespace DataServiceTest.Models.Repositories
{
	...
	public partial class CheckFingerRepository : BaseRepository<CheckFinger, int>, ICheckFingerRepository
	{
		...
		public override CheckFinger Remove(CheckFinger entity)
		{
		...
		public override CheckFinger Remove(int key)
		{
		...
		public override IEnumerable<CheckFinger> RemoveIf(Expression<Func<CheckFinger, bool>> expr)
		{
			return context.CheckFingers.RemoveRange(GetActive(expr).ToList());
		}
		
		public override IEnumerable<CheckFinger> RemoveRange(IEnumerable<CheckFinger> list)
		{
			return context.CheckFingers.RemoveRange(list);
		}
