...
namespace DataServiceTest.Models.Repositories
{
	...
	public partial class LanguageRepository : BaseRepository<Language, int>, ILanguageRepository
	{
		...
		public override async Task<Language> DeleteAsync(Language entity)
		{
			context.Languages.Attach(entity);
			entity = context.Languages.Remove(entity);
			if (AutoSave)
		...
		public override Language Delete(int key)
		{
		...
		public override async Task<Language> DeleteAsync(int key)
		{
			var entity = FindById(key);
			if (entity!=null)
				entity = context.Languages.Remove(entity);
