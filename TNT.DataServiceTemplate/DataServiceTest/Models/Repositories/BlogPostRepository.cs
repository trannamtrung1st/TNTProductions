...
namespace DataServiceTest.Models.Repositories
{
	...
	public partial class BlogPostRepository : BaseRepository<BlogPost, int>, IBlogPostRepository
	{
		...
		public override BlogPost Delete(BlogPost entity)
		{
		...
		public override async Task<BlogPost> DeleteAsync(BlogPost entity)
		{
			context.BlogPosts.Attach(entity);
			entity = context.BlogPosts.Remove(entity);
			if (AutoSave)
		...
		public override BlogPost Delete(int key)
		{
		...
		public override async Task<BlogPost> DeleteAsync(int key)
		{
			var entity = FindById(key);
			if (entity!=null)
				entity = context.BlogPosts.Remove(entity);
