...
namespace DataServiceTest.Models.Repositories
{
	...
	public partial class ContactRepository : BaseRepository<Contact, int>, IContactRepository
	{
		...
		public override Contact Delete(Contact entity)
		{
		...
		public override async Task<Contact> DeleteAsync(Contact entity)
		{
			context.Contacts.Attach(entity);
			entity = context.Contacts.Remove(entity);
			if (AutoSave)
		...
		public override Contact Delete(int key)
		{
		...
		public override async Task<Contact> DeleteAsync(int key)
		{
			var entity = FindById(key);
			if (entity!=null)
				entity = context.Contacts.Remove(entity);
