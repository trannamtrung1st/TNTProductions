...
namespace DataServiceTest.Models.Repositories
{
	...
	public partial class ProductImageCollectionItemMappingRepository : BaseRepository<ProductImageCollectionItemMapping, int>, IProductImageCollectionItemMappingRepository
	{
		...
		public override async Task<ProductImageCollectionItemMapping> AddAsync(ProductImageCollectionItemMapping entity)
		{
			entity.Active = true;
			entity = context.ProductImageCollectionItemMappings.Add(entity);
			if (AutoSave)
		...
		public override ProductImageCollectionItemMapping Delete(ProductImageCollectionItemMapping entity)
		{
		...
		public override async Task<ProductImageCollectionItemMapping> DeleteAsync(ProductImageCollectionItemMapping entity)
		{
			context.ProductImageCollectionItemMappings.Attach(entity);
			entity = context.ProductImageCollectionItemMappings.Remove(entity);
			if (AutoSave)
		...
		public override ProductImageCollectionItemMapping Delete(int key)
		{
		...
		public override async Task<ProductImageCollectionItemMapping> DeleteAsync(int key)
		{
			var entity = FindById(key);
			if (entity!=null)
				entity = context.ProductImageCollectionItemMappings.Remove(entity);
		...
		public override async Task<ProductImageCollectionItemMapping> UpdateAsync(ProductImageCollectionItemMapping entity)
		{
			entity = context.ProductImageCollectionItemMappings.Attach(entity);
			context.Entry(entity).State = EntityState.Modified;
			if (AutoSave)
