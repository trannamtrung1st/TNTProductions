...
namespace DataServiceTest.Models.Repositories
{
	...
	public partial class SalaryRuleRepository : BaseRepository<SalaryRule, int>, ISalaryRuleRepository
	{
		...
		public override async Task<SalaryRule> AddAsync(SalaryRule entity)
		{
			entity.Active = true;
			entity = context.SalaryRules.Add(entity);
			if (AutoSave)
		...
		public override SalaryRule Delete(SalaryRule entity)
		{
		...
		public override async Task<SalaryRule> DeleteAsync(SalaryRule entity)
		{
			context.SalaryRules.Attach(entity);
			entity = context.SalaryRules.Remove(entity);
			if (AutoSave)
		...
		public override SalaryRule Delete(int key)
		{
		...
		public override async Task<SalaryRule> DeleteAsync(int key)
		{
			var entity = FindById(key);
			if (entity!=null)
				entity = context.SalaryRules.Remove(entity);
		...
		public override async Task<SalaryRule> UpdateAsync(SalaryRule entity)
		{
			entity = context.SalaryRules.Attach(entity);
			context.Entry(entity).State = EntityState.Modified;
			if (AutoSave)
