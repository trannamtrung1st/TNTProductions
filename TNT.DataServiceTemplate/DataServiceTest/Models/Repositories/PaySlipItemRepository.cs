...
namespace DataServiceTest.Models.Repositories
{
	...
	public partial class PaySlipItemRepository : BaseRepository<PaySlipItem, int>, IPaySlipItemRepository
	{
		...
		public override async Task<PaySlipItem> AddAsync(PaySlipItem entity)
		{
			entity.Active = true;
			entity = context.PaySlipItems.Add(entity);
			if (AutoSave)
		...
		public override PaySlipItem Delete(PaySlipItem entity)
		{
		...
		public override async Task<PaySlipItem> DeleteAsync(PaySlipItem entity)
		{
			context.PaySlipItems.Attach(entity);
			entity = context.PaySlipItems.Remove(entity);
			if (AutoSave)
		...
		public override PaySlipItem Delete(int key)
		{
		...
		public override async Task<PaySlipItem> DeleteAsync(int key)
		{
			var entity = FindById(key);
			if (entity!=null)
				entity = context.PaySlipItems.Remove(entity);
		...
		public override async Task<PaySlipItem> UpdateAsync(PaySlipItem entity)
		{
			entity = context.PaySlipItems.Attach(entity);
			context.Entry(entity).State = EntityState.Modified;
			if (AutoSave)
