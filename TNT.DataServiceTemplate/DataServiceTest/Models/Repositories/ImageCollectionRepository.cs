...
namespace DataServiceTest.Models.Repositories
{
	...
	public partial class ImageCollectionRepository : BaseRepository<ImageCollection, int>, IImageCollectionRepository
	{
		...
		public override async Task<ImageCollection> AddAsync(ImageCollection entity)
		{
			entity.Active = true;
			entity = context.ImageCollections.Add(entity);
			if (AutoSave)
		...
		public override ImageCollection Delete(ImageCollection entity)
		{
		...
		public override async Task<ImageCollection> DeleteAsync(ImageCollection entity)
		{
			context.ImageCollections.Attach(entity);
			entity = context.ImageCollections.Remove(entity);
			if (AutoSave)
		...
		public override ImageCollection Delete(int key)
		{
		...
		public override async Task<ImageCollection> DeleteAsync(int key)
		{
			var entity = FindById(key);
			if (entity!=null)
				entity = context.ImageCollections.Remove(entity);
		...
		public override async Task<ImageCollection> UpdateAsync(ImageCollection entity)
		{
			entity = context.ImageCollections.Attach(entity);
			context.Entry(entity).State = EntityState.Modified;
			if (AutoSave)
