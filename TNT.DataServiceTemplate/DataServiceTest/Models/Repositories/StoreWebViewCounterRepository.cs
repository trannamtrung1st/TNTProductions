...
namespace DataServiceTest.Models.Repositories
{
	...
	public partial class StoreWebViewCounterRepository : BaseRepository<StoreWebViewCounter, int>, IStoreWebViewCounterRepository
	{
		...
		public override async Task<StoreWebViewCounter> AddAsync(StoreWebViewCounter entity)
		{
			entity.Active = true;
			entity = context.StoreWebViewCounters.Add(entity);
			if (AutoSave)
		...
		public override StoreWebViewCounter Delete(StoreWebViewCounter entity)
		{
		...
		public override async Task<StoreWebViewCounter> DeleteAsync(StoreWebViewCounter entity)
		{
			context.StoreWebViewCounters.Attach(entity);
			entity = context.StoreWebViewCounters.Remove(entity);
			if (AutoSave)
		...
		public override StoreWebViewCounter Delete(int key)
		{
		...
		public override async Task<StoreWebViewCounter> DeleteAsync(int key)
		{
			var entity = FindById(key);
			if (entity!=null)
				entity = context.StoreWebViewCounters.Remove(entity);
		...
		public override async Task<StoreWebViewCounter> UpdateAsync(StoreWebViewCounter entity)
		{
			entity = context.StoreWebViewCounters.Attach(entity);
			context.Entry(entity).State = EntityState.Modified;
			if (AutoSave)
