...
namespace DataServiceTest.Models.Repositories
{
	...
	public partial class BlogCategoryRepository : BaseRepository<BlogCategory, int>, IBlogCategoryRepository
	{
		...
		public override async Task<BlogCategory> AddAsync(BlogCategory entity)
		{
		...
		public override BlogCategory Delete(BlogCategory entity)
		{
		...
		public override async Task<BlogCategory> DeleteAsync(BlogCategory entity)
		{
			context.BlogCategories.Attach(entity);
			entity = context.BlogCategories.Remove(entity);
			if (AutoSave)
		...
		public override BlogCategory Delete(int key)
		{
		...
		public override async Task<BlogCategory> DeleteAsync(int key)
		{
			var entity = FindById(key);
			if (entity!=null)
				entity = context.BlogCategories.Remove(entity);
		...
		public override async Task<BlogCategory> UpdateAsync(BlogCategory entity)
		{
			entity = context.BlogCategories.Attach(entity);
			context.Entry(entity).State = EntityState.Modified;
			if (AutoSave)
