...
namespace DataServiceTest.Models.Repositories
{
	...
	public partial class AreaDeliveryRepository : BaseRepository<AreaDelivery, int>, IAreaDeliveryRepository
	{
		...
		public override async Task<AreaDelivery> AddAsync(AreaDelivery entity)
		{
		...
		public override AreaDelivery Delete(AreaDelivery entity)
		{
		...
		public override async Task<AreaDelivery> DeleteAsync(AreaDelivery entity)
		{
			context.AreaDeliveries.Attach(entity);
			entity = context.AreaDeliveries.Remove(entity);
			if (AutoSave)
		...
		public override AreaDelivery Delete(int key)
		{
		...
		public override async Task<AreaDelivery> DeleteAsync(int key)
		{
			var entity = FindById(key);
			if (entity!=null)
				entity = context.AreaDeliveries.Remove(entity);
		...
		public override async Task<AreaDelivery> UpdateAsync(AreaDelivery entity)
		{
			entity = context.AreaDeliveries.Attach(entity);
			context.Entry(entity).State = EntityState.Modified;
			if (AutoSave)
