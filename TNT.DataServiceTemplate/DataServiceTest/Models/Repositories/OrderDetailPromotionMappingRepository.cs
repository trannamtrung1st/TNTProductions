...
namespace DataServiceTest.Models.Repositories
{
	...
	public partial class OrderDetailPromotionMappingRepository : BaseRepository<OrderDetailPromotionMapping, int>, IOrderDetailPromotionMappingRepository
	{
		...
		public override async Task<OrderDetailPromotionMapping> AddAsync(OrderDetailPromotionMapping entity)
		{
			entity.Active = true;
			entity = context.OrderDetailPromotionMappings.Add(entity);
			if (AutoSave)
		...
		public override OrderDetailPromotionMapping Delete(OrderDetailPromotionMapping entity)
		{
		...
		public override async Task<OrderDetailPromotionMapping> DeleteAsync(OrderDetailPromotionMapping entity)
		{
			context.OrderDetailPromotionMappings.Attach(entity);
			entity = context.OrderDetailPromotionMappings.Remove(entity);
			if (AutoSave)
		...
		public override OrderDetailPromotionMapping Delete(int key)
		{
		...
		public override async Task<OrderDetailPromotionMapping> DeleteAsync(int key)
		{
			var entity = FindById(key);
			if (entity!=null)
				entity = context.OrderDetailPromotionMappings.Remove(entity);
		...
		public override async Task<OrderDetailPromotionMapping> UpdateAsync(OrderDetailPromotionMapping entity)
		{
			entity = context.OrderDetailPromotionMappings.Attach(entity);
			context.Entry(entity).State = EntityState.Modified;
			if (AutoSave)
