...
namespace DataServiceTest.Models.Repositories
{
	...
	public partial class WebPageRepository : BaseRepository<WebPage, int>, IWebPageRepository
	{
		...
		public override WebPage Remove(WebPage entity)
		{
		...
		public override WebPage Remove(int key)
		{
		...
		public override IEnumerable<WebPage> RemoveIf(Expression<Func<WebPage, bool>> expr)
		{
			return context.WebPages.RemoveRange(GetActive(expr).ToList());
		}
		
		public override IEnumerable<WebPage> RemoveRange(IEnumerable<WebPage> list)
		{
			return context.WebPages.RemoveRange(list);
		}
