...
namespace DataServiceTest.Models.Repositories
{
	...
	public partial class sysdiagramRepository : BaseRepository<sysdiagram, int>, IsysdiagramRepository
	{
		...
		public override async Task<sysdiagram> AddAsync(sysdiagram entity)
		{
		...
		public override sysdiagram Delete(sysdiagram entity)
		{
		...
		public override async Task<sysdiagram> DeleteAsync(sysdiagram entity)
		{
			context.sysdiagrams.Attach(entity);
			entity = context.sysdiagrams.Remove(entity);
			if (AutoSave)
		...
		public override sysdiagram Delete(int key)
		{
		...
		public override async Task<sysdiagram> DeleteAsync(int key)
		{
			var entity = FindById(key);
			if (entity!=null)
				entity = context.sysdiagrams.Remove(entity);
		...
		public override async Task<sysdiagram> UpdateAsync(sysdiagram entity)
		{
			entity = context.sysdiagrams.Attach(entity);
			context.Entry(entity).State = EntityState.Modified;
			if (AutoSave)
