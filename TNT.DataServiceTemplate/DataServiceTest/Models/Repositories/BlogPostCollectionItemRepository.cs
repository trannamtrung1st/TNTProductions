...
namespace DataServiceTest.Models.Repositories
{
	...
	public partial class BlogPostCollectionItemRepository : BaseRepository<BlogPostCollectionItem, int>, IBlogPostCollectionItemRepository
	{
		...
		public override async Task<BlogPostCollectionItem> AddAsync(BlogPostCollectionItem entity)
		{
			entity.Active = true;
			entity = context.BlogPostCollectionItems.Add(entity);
			if (AutoSave)
		...
		public override BlogPostCollectionItem Delete(BlogPostCollectionItem entity)
		{
		...
		public override async Task<BlogPostCollectionItem> DeleteAsync(BlogPostCollectionItem entity)
		{
			context.BlogPostCollectionItems.Attach(entity);
			entity = context.BlogPostCollectionItems.Remove(entity);
			if (AutoSave)
		...
		public override BlogPostCollectionItem Delete(int key)
		{
		...
		public override async Task<BlogPostCollectionItem> DeleteAsync(int key)
		{
			var entity = FindById(key);
			if (entity!=null)
				entity = context.BlogPostCollectionItems.Remove(entity);
		...
		public override async Task<BlogPostCollectionItem> UpdateAsync(BlogPostCollectionItem entity)
		{
			entity = context.BlogPostCollectionItems.Attach(entity);
			context.Entry(entity).State = EntityState.Modified;
			if (AutoSave)
