...
namespace DataServiceTest.Models.Repositories
{
	...
	public partial class StoreUserRepository : BaseRepository<StoreUser, StoreUserPK>, IStoreUserRepository
	{
		...
		public override StoreUser Remove(StoreUser entity)
		{
		...
		public override StoreUser Remove(StoreUserPK key)
		{
		...
		public override IEnumerable<StoreUser> RemoveIf(Expression<Func<StoreUser, bool>> expr)
		{
			return context.StoreUsers.RemoveRange(GetActive(expr).ToList());
		}
		
		public override IEnumerable<StoreUser> RemoveRange(IEnumerable<StoreUser> list)
		{
			return context.StoreUsers.RemoveRange(list);
		}
