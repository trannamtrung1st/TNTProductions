...
namespace DataServiceTest.Models.Repositories
{
	...
	public partial class CategoryExtraMappingRepository : BaseRepository<CategoryExtraMapping, int>, ICategoryExtraMappingRepository
	{
		...
		public override CategoryExtraMapping Remove(CategoryExtraMapping entity)
		{
		...
		public override CategoryExtraMapping Remove(int key)
		{
		...
		public override IEnumerable<CategoryExtraMapping> RemoveIf(Expression<Func<CategoryExtraMapping, bool>> expr)
		{
			return context.CategoryExtraMappings.RemoveRange(GetActive(expr).ToList());
		}
		
		public override IEnumerable<CategoryExtraMapping> RemoveRange(IEnumerable<CategoryExtraMapping> list)
		{
			return context.CategoryExtraMappings.RemoveRange(list);
		}
