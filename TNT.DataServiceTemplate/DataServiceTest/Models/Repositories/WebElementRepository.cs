...
namespace DataServiceTest.Models.Repositories
{
	...
	public partial class WebElementRepository : BaseRepository<WebElement, int>, IWebElementRepository
	{
		...
		public override async Task<WebElement> AddAsync(WebElement entity)
		{
			entity.Active = true;
			entity = context.WebElements.Add(entity);
			if (AutoSave)
		...
		public override WebElement Delete(WebElement entity)
		{
		...
		public override async Task<WebElement> DeleteAsync(WebElement entity)
		{
			context.WebElements.Attach(entity);
			entity = context.WebElements.Remove(entity);
			if (AutoSave)
		...
		public override WebElement Delete(int key)
		{
		...
		public override async Task<WebElement> DeleteAsync(int key)
		{
			var entity = FindById(key);
			if (entity!=null)
				entity = context.WebElements.Remove(entity);
		...
		public override async Task<WebElement> UpdateAsync(WebElement entity)
		{
			entity = context.WebElements.Attach(entity);
			context.Entry(entity).State = EntityState.Modified;
			if (AutoSave)
