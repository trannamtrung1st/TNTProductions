...
namespace DataServiceTest.Models.Repositories
{
	...
	public partial class RoomRepository : BaseRepository<Room, int>, IRoomRepository
	{
		...
		public override Room Delete(Room entity)
		{
		...
		public override async Task<Room> DeleteAsync(Room entity)
		{
			context.Rooms.Attach(entity);
			entity = context.Rooms.Remove(entity);
			if (AutoSave)
		...
		public override Room Delete(int key)
		{
		...
		public override async Task<Room> DeleteAsync(int key)
		{
			var entity = FindById(key);
			if (entity!=null)
				entity = context.Rooms.Remove(entity);
