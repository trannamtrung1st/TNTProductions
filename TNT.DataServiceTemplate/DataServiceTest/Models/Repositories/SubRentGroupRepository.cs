...
namespace DataServiceTest.Models.Repositories
{
	...
	public partial class SubRentGroupRepository : BaseRepository<SubRentGroup, int>, ISubRentGroupRepository
	{
		...
		public override async Task<SubRentGroup> AddAsync(SubRentGroup entity)
		{
		...
		public override SubRentGroup Delete(SubRentGroup entity)
		{
		...
		public override async Task<SubRentGroup> DeleteAsync(SubRentGroup entity)
		{
			context.SubRentGroups.Attach(entity);
			entity = context.SubRentGroups.Remove(entity);
			if (AutoSave)
		...
		public override SubRentGroup Delete(int key)
		{
		...
		public override async Task<SubRentGroup> DeleteAsync(int key)
		{
			var entity = FindById(key);
			if (entity!=null)
				entity = context.SubRentGroups.Remove(entity);
		...
		public override async Task<SubRentGroup> UpdateAsync(SubRentGroup entity)
		{
			entity = context.SubRentGroups.Attach(entity);
			context.Entry(entity).State = EntityState.Modified;
			if (AutoSave)
