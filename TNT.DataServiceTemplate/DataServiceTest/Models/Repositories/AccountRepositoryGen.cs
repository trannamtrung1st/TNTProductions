...
namespace DataServiceTest.Models.Repositories
{
	...
	public partial class AccountRepository : BaseRepository<Account, int>, IAccountRepository
	{
		...
		public override Account Remove(Account entity)
		{
		...
		public override Account Remove(int key)
		{
		...
		public override IEnumerable<Account> RemoveIf(Expression<Func<Account, bool>> expr)
		{
			return context.Accounts.RemoveRange(GetActive(expr).ToList());
		}
		
		public override IEnumerable<Account> RemoveRange(IEnumerable<Account> list)
		{
			return context.Accounts.RemoveRange(list);
		}
