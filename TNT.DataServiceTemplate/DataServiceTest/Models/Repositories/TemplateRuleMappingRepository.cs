...
namespace DataServiceTest.Models.Repositories
{
	...
	public partial class TemplateRuleMappingRepository : BaseRepository<TemplateRuleMapping, int>, ITemplateRuleMappingRepository
	{
		...
		public override async Task<TemplateRuleMapping> AddAsync(TemplateRuleMapping entity)
		{
			entity.Active = true;
			entity = context.TemplateRuleMappings.Add(entity);
			if (AutoSave)
		...
		public override TemplateRuleMapping Delete(TemplateRuleMapping entity)
		{
		...
		public override async Task<TemplateRuleMapping> DeleteAsync(TemplateRuleMapping entity)
		{
			context.TemplateRuleMappings.Attach(entity);
			entity = context.TemplateRuleMappings.Remove(entity);
			if (AutoSave)
		...
		public override TemplateRuleMapping Delete(int key)
		{
		...
		public override async Task<TemplateRuleMapping> DeleteAsync(int key)
		{
			var entity = FindById(key);
			if (entity!=null)
				entity = context.TemplateRuleMappings.Remove(entity);
		...
		public override async Task<TemplateRuleMapping> UpdateAsync(TemplateRuleMapping entity)
		{
			entity = context.TemplateRuleMappings.Attach(entity);
			context.Entry(entity).State = EntityState.Modified;
			if (AutoSave)
