...
namespace DataServiceTest.Models.Repositories
{
	...
	public partial class MembershipCardTypeRepository : BaseRepository<MembershipCardType, int>, IMembershipCardTypeRepository
	{
		...
		public override async Task<MembershipCardType> AddAsync(MembershipCardType entity)
		{
		...
		public override MembershipCardType Delete(MembershipCardType entity)
		{
		...
		public override async Task<MembershipCardType> DeleteAsync(MembershipCardType entity)
		{
			context.MembershipCardTypes.Attach(entity);
			entity = context.MembershipCardTypes.Remove(entity);
			if (AutoSave)
		...
		public override MembershipCardType Delete(int key)
		{
		...
		public override async Task<MembershipCardType> DeleteAsync(int key)
		{
			var entity = FindById(key);
			if (entity!=null)
				entity = context.MembershipCardTypes.Remove(entity);
		...
		public override async Task<MembershipCardType> UpdateAsync(MembershipCardType entity)
		{
			entity = context.MembershipCardTypes.Attach(entity);
			context.Entry(entity).State = EntityState.Modified;
			if (AutoSave)
