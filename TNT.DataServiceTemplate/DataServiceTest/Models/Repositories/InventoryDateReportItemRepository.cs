...
namespace DataServiceTest.Models.Repositories
{
	...
	public partial class InventoryDateReportItemRepository : BaseRepository<InventoryDateReportItem, InventoryDateReportItemPK>, IInventoryDateReportItemRepository
	{
		...
		public override async Task<InventoryDateReportItem> AddAsync(InventoryDateReportItem entity)
		{
		...
		public override InventoryDateReportItem Delete(InventoryDateReportItem entity)
		{
		...
		public override async Task<InventoryDateReportItem> DeleteAsync(InventoryDateReportItem entity)
		{
			context.InventoryDateReportItems.Attach(entity);
			entity = context.InventoryDateReportItems.Remove(entity);
			if (AutoSave)
		...
		public override InventoryDateReportItem Delete(InventoryDateReportItemPK key)
		{
		...
		public override async Task<InventoryDateReportItem> DeleteAsync(InventoryDateReportItemPK key)
		{
			var entity = FindById(key);
			if (entity!=null)
				entity = context.InventoryDateReportItems.Remove(entity);
		...
		public override async Task<InventoryDateReportItem> UpdateAsync(InventoryDateReportItem entity)
		{
			entity = context.InventoryDateReportItems.Attach(entity);
			context.Entry(entity).State = EntityState.Modified;
			if (AutoSave)
