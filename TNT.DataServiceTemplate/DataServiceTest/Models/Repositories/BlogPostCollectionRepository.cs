...
namespace DataServiceTest.Models.Repositories
{
	...
	public partial class BlogPostCollectionRepository : BaseRepository<BlogPostCollection, int>, IBlogPostCollectionRepository
	{
		...
		public override async Task<BlogPostCollection> AddAsync(BlogPostCollection entity)
		{
			entity.Active = true;
			entity = context.BlogPostCollections.Add(entity);
			if (AutoSave)
		...
		public override BlogPostCollection Delete(BlogPostCollection entity)
		{
		...
		public override async Task<BlogPostCollection> DeleteAsync(BlogPostCollection entity)
		{
			context.BlogPostCollections.Attach(entity);
			entity = context.BlogPostCollections.Remove(entity);
			if (AutoSave)
		...
		public override BlogPostCollection Delete(int key)
		{
		...
		public override async Task<BlogPostCollection> DeleteAsync(int key)
		{
			var entity = FindById(key);
			if (entity!=null)
				entity = context.BlogPostCollections.Remove(entity);
		...
		public override async Task<BlogPostCollection> UpdateAsync(BlogPostCollection entity)
		{
			entity = context.BlogPostCollections.Attach(entity);
			context.Entry(entity).State = EntityState.Modified;
			if (AutoSave)
