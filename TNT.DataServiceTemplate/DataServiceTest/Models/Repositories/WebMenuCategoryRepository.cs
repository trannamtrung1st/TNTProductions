...
namespace DataServiceTest.Models.Repositories
{
	...
	public partial class WebMenuCategoryRepository : BaseRepository<WebMenuCategory, int>, IWebMenuCategoryRepository
	{
		...
		public override async Task<WebMenuCategory> AddAsync(WebMenuCategory entity)
		{
		...
		public override WebMenuCategory Delete(WebMenuCategory entity)
		{
		...
		public override async Task<WebMenuCategory> DeleteAsync(WebMenuCategory entity)
		{
			context.WebMenuCategories.Attach(entity);
			entity = context.WebMenuCategories.Remove(entity);
			if (AutoSave)
		...
		public override WebMenuCategory Delete(int key)
		{
		...
		public override async Task<WebMenuCategory> DeleteAsync(int key)
		{
			var entity = FindById(key);
			if (entity!=null)
				entity = context.WebMenuCategories.Remove(entity);
		...
		public override async Task<WebMenuCategory> UpdateAsync(WebMenuCategory entity)
		{
			entity = context.WebMenuCategories.Attach(entity);
			context.Entry(entity).State = EntityState.Modified;
			if (AutoSave)
