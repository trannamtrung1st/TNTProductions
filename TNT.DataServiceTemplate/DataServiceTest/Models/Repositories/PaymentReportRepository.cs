...
namespace DataServiceTest.Models.Repositories
{
	...
	public partial class PaymentReportRepository : BaseRepository<PaymentReport, int>, IPaymentReportRepository
	{
		...
		public override async Task<PaymentReport> AddAsync(PaymentReport entity)
		{
		...
		public override PaymentReport Delete(PaymentReport entity)
		{
		...
		public override async Task<PaymentReport> DeleteAsync(PaymentReport entity)
		{
			context.PaymentReports.Attach(entity);
			entity = context.PaymentReports.Remove(entity);
			if (AutoSave)
		...
		public override PaymentReport Delete(int key)
		{
		...
		public override async Task<PaymentReport> DeleteAsync(int key)
		{
			var entity = FindById(key);
			if (entity!=null)
				entity = context.PaymentReports.Remove(entity);
		...
		public override async Task<PaymentReport> UpdateAsync(PaymentReport entity)
		{
			entity = context.PaymentReports.Attach(entity);
			context.Entry(entity).State = EntityState.Modified;
			if (AutoSave)
