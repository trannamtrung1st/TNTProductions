...
namespace DataServiceTest.Models.Repositories
{
	...
	public partial class StoreThemeRepository : BaseRepository<StoreTheme, int>, IStoreThemeRepository
	{
		...
		public override async Task<StoreTheme> AddAsync(StoreTheme entity)
		{
			entity.Active = true;
			entity = context.StoreThemes.Add(entity);
			if (AutoSave)
		...
		public override StoreTheme Delete(StoreTheme entity)
		{
		...
		public override async Task<StoreTheme> DeleteAsync(StoreTheme entity)
		{
			context.StoreThemes.Attach(entity);
			entity = context.StoreThemes.Remove(entity);
			if (AutoSave)
		...
		public override StoreTheme Delete(int key)
		{
		...
		public override async Task<StoreTheme> DeleteAsync(int key)
		{
			var entity = FindById(key);
			if (entity!=null)
				entity = context.StoreThemes.Remove(entity);
		...
		public override async Task<StoreTheme> UpdateAsync(StoreTheme entity)
		{
			entity = context.StoreThemes.Attach(entity);
			context.Entry(entity).State = EntityState.Modified;
			if (AutoSave)
