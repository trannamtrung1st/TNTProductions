...
namespace DataServiceTest.Models.Repositories
{
	...
	public partial class InventoryReceiptRepository : BaseRepository<InventoryReceipt, int>, IInventoryReceiptRepository
	{
		...
		public override async Task<InventoryReceipt> AddAsync(InventoryReceipt entity)
		{
		...
		public override InventoryReceipt Delete(InventoryReceipt entity)
		{
		...
		public override async Task<InventoryReceipt> DeleteAsync(InventoryReceipt entity)
		{
			context.InventoryReceipts.Attach(entity);
			entity = context.InventoryReceipts.Remove(entity);
			if (AutoSave)
		...
		public override InventoryReceipt Delete(int key)
		{
		...
		public override async Task<InventoryReceipt> DeleteAsync(int key)
		{
			var entity = FindById(key);
			if (entity!=null)
				entity = context.InventoryReceipts.Remove(entity);
		...
		public override async Task<InventoryReceipt> UpdateAsync(InventoryReceipt entity)
		{
			entity = context.InventoryReceipts.Attach(entity);
			context.Entry(entity).State = EntityState.Modified;
			if (AutoSave)
