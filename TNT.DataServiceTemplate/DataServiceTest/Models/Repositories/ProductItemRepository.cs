...
namespace DataServiceTest.Models.Repositories
{
	...
	public partial class ProductItemRepository : BaseRepository<ProductItem, int>, IProductItemRepository
	{
		...
		public override async Task<ProductItem> AddAsync(ProductItem entity)
		{
		...
		public override ProductItem Delete(ProductItem entity)
		{
		...
		public override async Task<ProductItem> DeleteAsync(ProductItem entity)
		{
			context.ProductItems.Attach(entity);
			entity = context.ProductItems.Remove(entity);
			if (AutoSave)
		...
		public override ProductItem Delete(int key)
		{
		...
		public override async Task<ProductItem> DeleteAsync(int key)
		{
			var entity = FindById(key);
			if (entity!=null)
				entity = context.ProductItems.Remove(entity);
		...
		public override async Task<ProductItem> UpdateAsync(ProductItem entity)
		{
			entity = context.ProductItems.Attach(entity);
			context.Entry(entity).State = EntityState.Modified;
			if (AutoSave)
