...
namespace DataServiceTest.Models.Repositories
{
	...
	public partial class EmployeeRepository : BaseRepository<Employee, int>, IEmployeeRepository
	{
		...
		public override Employee Delete(Employee entity)
		{
		...
		public override async Task<Employee> DeleteAsync(Employee entity)
		{
			context.Employees.Attach(entity);
			entity = context.Employees.Remove(entity);
			if (AutoSave)
		...
		public override Employee Delete(int key)
		{
		...
		public override async Task<Employee> DeleteAsync(int key)
		{
			var entity = FindById(key);
			if (entity!=null)
				entity = context.Employees.Remove(entity);
