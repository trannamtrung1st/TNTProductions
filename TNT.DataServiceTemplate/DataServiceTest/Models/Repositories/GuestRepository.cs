...
namespace DataServiceTest.Models.Repositories
{
	...
	public partial class GuestRepository : BaseRepository<Guest, int>, IGuestRepository
	{
		...
		public override async Task<Guest> AddAsync(Guest entity)
		{
		...
		public override Guest Delete(Guest entity)
		{
		...
		public override async Task<Guest> DeleteAsync(Guest entity)
		{
			context.Guests.Attach(entity);
			entity = context.Guests.Remove(entity);
			if (AutoSave)
		...
		public override Guest Delete(int key)
		{
		...
		public override async Task<Guest> DeleteAsync(int key)
		{
			var entity = FindById(key);
			if (entity!=null)
				entity = context.Guests.Remove(entity);
		...
		public override async Task<Guest> UpdateAsync(Guest entity)
		{
			entity = context.Guests.Attach(entity);
			context.Entry(entity).State = EntityState.Modified;
			if (AutoSave)
