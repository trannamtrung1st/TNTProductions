...
namespace DataServiceTest.Models.Repositories
{
	...
	public partial class LanguageKeyRepository : BaseRepository<LanguageKey, int>, ILanguageKeyRepository
	{
		...
		public override async Task<LanguageKey> AddAsync(LanguageKey entity)
		{
			entity.Active = true;
			entity = context.LanguageKeys.Add(entity);
			if (AutoSave)
		...
		public override LanguageKey Delete(LanguageKey entity)
		{
		...
		public override async Task<LanguageKey> DeleteAsync(LanguageKey entity)
		{
			context.LanguageKeys.Attach(entity);
			entity = context.LanguageKeys.Remove(entity);
			if (AutoSave)
		...
		public override LanguageKey Delete(int key)
		{
		...
		public override async Task<LanguageKey> DeleteAsync(int key)
		{
			var entity = FindById(key);
			if (entity!=null)
				entity = context.LanguageKeys.Remove(entity);
		...
		public override async Task<LanguageKey> UpdateAsync(LanguageKey entity)
		{
			entity = context.LanguageKeys.Attach(entity);
			context.Entry(entity).State = EntityState.Modified;
			if (AutoSave)
