...
namespace DataServiceTest.Models.Repositories
{
	...
	public partial class RoomCategoryPriceGroupMappingRepository : BaseRepository<RoomCategoryPriceGroupMapping, RoomCategoryPriceGroupMappingPK>, IRoomCategoryPriceGroupMappingRepository
	{
		...
		public override async Task<RoomCategoryPriceGroupMapping> AddAsync(RoomCategoryPriceGroupMapping entity)
		{
		...
		public override RoomCategoryPriceGroupMapping Delete(RoomCategoryPriceGroupMapping entity)
		{
		...
		public override async Task<RoomCategoryPriceGroupMapping> DeleteAsync(RoomCategoryPriceGroupMapping entity)
		{
			context.RoomCategoryPriceGroupMappings.Attach(entity);
			entity = context.RoomCategoryPriceGroupMappings.Remove(entity);
			if (AutoSave)
		...
		public override RoomCategoryPriceGroupMapping Delete(RoomCategoryPriceGroupMappingPK key)
		{
		...
		public override async Task<RoomCategoryPriceGroupMapping> DeleteAsync(RoomCategoryPriceGroupMappingPK key)
		{
			var entity = FindById(key);
			if (entity!=null)
				entity = context.RoomCategoryPriceGroupMappings.Remove(entity);
		...
		public override async Task<RoomCategoryPriceGroupMapping> UpdateAsync(RoomCategoryPriceGroupMapping entity)
		{
			entity = context.RoomCategoryPriceGroupMappings.Attach(entity);
			context.Entry(entity).State = EntityState.Modified;
			if (AutoSave)
