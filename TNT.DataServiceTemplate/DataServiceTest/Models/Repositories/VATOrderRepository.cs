...
namespace DataServiceTest.Models.Repositories
{
	...
	public partial class VATOrderRepository : BaseRepository<VATOrder, int>, IVATOrderRepository
	{
		...
		public override async Task<VATOrder> AddAsync(VATOrder entity)
		{
		...
		public override VATOrder Delete(VATOrder entity)
		{
		...
		public override async Task<VATOrder> DeleteAsync(VATOrder entity)
		{
			context.VATOrders.Attach(entity);
			entity = context.VATOrders.Remove(entity);
			if (AutoSave)
		...
		public override VATOrder Delete(int key)
		{
		...
		public override async Task<VATOrder> DeleteAsync(int key)
		{
			var entity = FindById(key);
			if (entity!=null)
				entity = context.VATOrders.Remove(entity);
		...
		public override async Task<VATOrder> UpdateAsync(VATOrder entity)
		{
			entity = context.VATOrders.Attach(entity);
			context.Entry(entity).State = EntityState.Modified;
			if (AutoSave)
