...
namespace DataServiceTest.Models.Repositories
{
	...
	public partial class LanguageValueRepository : BaseRepository<LanguageValue, int>, ILanguageValueRepository
	{
		...
		public override async Task<LanguageValue> AddAsync(LanguageValue entity)
		{
			entity.Active = true;
			entity = context.LanguageValues.Add(entity);
			if (AutoSave)
		...
		public override LanguageValue Delete(LanguageValue entity)
		{
		...
		public override async Task<LanguageValue> DeleteAsync(LanguageValue entity)
		{
			context.LanguageValues.Attach(entity);
			entity = context.LanguageValues.Remove(entity);
			if (AutoSave)
		...
		public override LanguageValue Delete(int key)
		{
		...
		public override async Task<LanguageValue> DeleteAsync(int key)
		{
			var entity = FindById(key);
			if (entity!=null)
				entity = context.LanguageValues.Remove(entity);
		...
		public override async Task<LanguageValue> UpdateAsync(LanguageValue entity)
		{
			entity = context.LanguageValues.Attach(entity);
			context.Entry(entity).State = EntityState.Modified;
			if (AutoSave)
