...
namespace DataServiceTest.Models.Repositories
{
	...
	public partial class CostInventoryMappingRepository : BaseRepository<CostInventoryMapping, CostInventoryMappingPK>, ICostInventoryMappingRepository
	{
		...
		public override CostInventoryMapping Remove(CostInventoryMapping entity)
		{
		...
		public override CostInventoryMapping Remove(CostInventoryMappingPK key)
		{
		...
		public override IEnumerable<CostInventoryMapping> RemoveIf(Expression<Func<CostInventoryMapping, bool>> expr)
		{
			return context.CostInventoryMappings.RemoveRange(GetActive(expr).ToList());
		}
		
		public override IEnumerable<CostInventoryMapping> RemoveRange(IEnumerable<CostInventoryMapping> list)
		{
			return context.CostInventoryMappings.RemoveRange(list);
		}
