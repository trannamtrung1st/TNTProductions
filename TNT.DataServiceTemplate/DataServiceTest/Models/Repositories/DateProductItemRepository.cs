...
namespace DataServiceTest.Models.Repositories
{
	...
	public partial class DateProductItemRepository : BaseRepository<DateProductItem, int>, IDateProductItemRepository
	{
		...
		public override async Task<DateProductItem> AddAsync(DateProductItem entity)
		{
		...
		public override DateProductItem Delete(DateProductItem entity)
		{
		...
		public override async Task<DateProductItem> DeleteAsync(DateProductItem entity)
		{
			context.DateProductItems.Attach(entity);
			entity = context.DateProductItems.Remove(entity);
			if (AutoSave)
		...
		public override DateProductItem Delete(int key)
		{
		...
		public override async Task<DateProductItem> DeleteAsync(int key)
		{
			var entity = FindById(key);
			if (entity!=null)
				entity = context.DateProductItems.Remove(entity);
		...
		public override async Task<DateProductItem> UpdateAsync(DateProductItem entity)
		{
			entity = context.DateProductItems.Attach(entity);
			context.Entry(entity).State = EntityState.Modified;
			if (AutoSave)
