...
namespace DataServiceTest.Models.Repositories
{
	...
	public partial class PaymentPartnerRepository : BaseRepository<PaymentPartner, int>, IPaymentPartnerRepository
	{
		...
		public override async Task<PaymentPartner> AddAsync(PaymentPartner entity)
		{
			entity.Active = true;
			entity = context.PaymentPartners.Add(entity);
			if (AutoSave)
		...
		public override PaymentPartner Delete(PaymentPartner entity)
		{
		...
		public override async Task<PaymentPartner> DeleteAsync(PaymentPartner entity)
		{
			context.PaymentPartners.Attach(entity);
			entity = context.PaymentPartners.Remove(entity);
			if (AutoSave)
		...
		public override PaymentPartner Delete(int key)
		{
		...
		public override async Task<PaymentPartner> DeleteAsync(int key)
		{
			var entity = FindById(key);
			if (entity!=null)
				entity = context.PaymentPartners.Remove(entity);
		...
		public override async Task<PaymentPartner> UpdateAsync(PaymentPartner entity)
		{
			entity = context.PaymentPartners.Attach(entity);
			context.Entry(entity).State = EntityState.Modified;
			if (AutoSave)
