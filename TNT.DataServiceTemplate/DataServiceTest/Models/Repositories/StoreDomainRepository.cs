...
namespace DataServiceTest.Models.Repositories
{
	...
	public partial class StoreDomainRepository : BaseRepository<StoreDomain, int>, IStoreDomainRepository
	{
		...
		public override async Task<StoreDomain> AddAsync(StoreDomain entity)
		{
			entity.Active = true;
			entity = context.StoreDomains.Add(entity);
			if (AutoSave)
		...
		public override StoreDomain Delete(StoreDomain entity)
		{
		...
		public override async Task<StoreDomain> DeleteAsync(StoreDomain entity)
		{
			context.StoreDomains.Attach(entity);
			entity = context.StoreDomains.Remove(entity);
			if (AutoSave)
		...
		public override StoreDomain Delete(int key)
		{
		...
		public override async Task<StoreDomain> DeleteAsync(int key)
		{
			var entity = FindById(key);
			if (entity!=null)
				entity = context.StoreDomains.Remove(entity);
		...
		public override async Task<StoreDomain> UpdateAsync(StoreDomain entity)
		{
			entity = context.StoreDomains.Attach(entity);
			context.Entry(entity).State = EntityState.Modified;
			if (AutoSave)
