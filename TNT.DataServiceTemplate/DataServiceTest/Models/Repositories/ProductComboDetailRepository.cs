...
namespace DataServiceTest.Models.Repositories
{
	...
	public partial class ProductComboDetailRepository : BaseRepository<ProductComboDetail, ProductComboDetailPK>, IProductComboDetailRepository
	{
		...
		public override async Task<ProductComboDetail> AddAsync(ProductComboDetail entity)
		{
			entity.Active = true;
			entity = context.ProductComboDetails.Add(entity);
			if (AutoSave)
		...
		public override ProductComboDetail Delete(ProductComboDetail entity)
		{
		...
		public override async Task<ProductComboDetail> DeleteAsync(ProductComboDetail entity)
		{
			context.ProductComboDetails.Attach(entity);
			entity = context.ProductComboDetails.Remove(entity);
			if (AutoSave)
		...
		public override ProductComboDetail Delete(ProductComboDetailPK key)
		{
		...
		public override async Task<ProductComboDetail> DeleteAsync(ProductComboDetailPK key)
		{
			var entity = FindById(key);
			if (entity!=null)
				entity = context.ProductComboDetails.Remove(entity);
		...
		public override async Task<ProductComboDetail> UpdateAsync(ProductComboDetail entity)
		{
			entity = context.ProductComboDetails.Attach(entity);
			context.Entry(entity).State = EntityState.Modified;
			if (AutoSave)
