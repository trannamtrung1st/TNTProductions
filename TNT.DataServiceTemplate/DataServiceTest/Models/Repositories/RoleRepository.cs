...
namespace DataServiceTest.Models.Repositories
{
	...
	public partial class RoleRepository : BaseRepository<Role, System.Guid>, IRoleRepository
	{
		...
		public override async Task<Role> DeleteAsync(Role entity)
		{
			context.Roles.Attach(entity);
			entity = context.Roles.Remove(entity);
			if (AutoSave)
		...
		public override Role Delete(System.Guid key)
		{
		...
		public override async Task<Role> DeleteAsync(System.Guid key)
		{
			var entity = FindById(key);
			if (entity!=null)
				entity = context.Roles.Remove(entity);
