...
namespace DataServiceTest.Models.Repositories
{
	...
	public partial class RatingStarRepository : BaseRepository<RatingStar, int>, IRatingStarRepository
	{
		...
		public override async Task<RatingStar> AddAsync(RatingStar entity)
		{
		...
		public override RatingStar Delete(RatingStar entity)
		{
		...
		public override async Task<RatingStar> DeleteAsync(RatingStar entity)
		{
			context.RatingStars.Attach(entity);
			entity = context.RatingStars.Remove(entity);
			if (AutoSave)
		...
		public override RatingStar Delete(int key)
		{
		...
		public override async Task<RatingStar> DeleteAsync(int key)
		{
			var entity = FindById(key);
			if (entity!=null)
				entity = context.RatingStars.Remove(entity);
		...
		public override async Task<RatingStar> UpdateAsync(RatingStar entity)
		{
			entity = context.RatingStars.Attach(entity);
			context.Entry(entity).State = EntityState.Modified;
			if (AutoSave)
