...
namespace DataServiceTest.Models.Repositories
{
	...
	public partial class RoomFloorRepository : BaseRepository<RoomFloor, int>, IRoomFloorRepository
	{
		...
		public override async Task<RoomFloor> AddAsync(RoomFloor entity)
		{
		...
		public override RoomFloor Delete(RoomFloor entity)
		{
		...
		public override async Task<RoomFloor> DeleteAsync(RoomFloor entity)
		{
			context.RoomFloors.Attach(entity);
			entity = context.RoomFloors.Remove(entity);
			if (AutoSave)
		...
		public override RoomFloor Delete(int key)
		{
		...
		public override async Task<RoomFloor> DeleteAsync(int key)
		{
			var entity = FindById(key);
			if (entity!=null)
				entity = context.RoomFloors.Remove(entity);
		...
		public override async Task<RoomFloor> UpdateAsync(RoomFloor entity)
		{
			entity = context.RoomFloors.Attach(entity);
			context.Entry(entity).State = EntityState.Modified;
			if (AutoSave)
