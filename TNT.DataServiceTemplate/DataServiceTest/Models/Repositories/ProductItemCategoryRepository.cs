...
namespace DataServiceTest.Models.Repositories
{
	...
	public partial class ProductItemCategoryRepository : BaseRepository<ProductItemCategory, int>, IProductItemCategoryRepository
	{
		...
		public override async Task<ProductItemCategory> AddAsync(ProductItemCategory entity)
		{
			entity.Active = true;
			entity = context.ProductItemCategories.Add(entity);
			if (AutoSave)
		...
		public override ProductItemCategory Delete(ProductItemCategory entity)
		{
		...
		public override async Task<ProductItemCategory> DeleteAsync(ProductItemCategory entity)
		{
			context.ProductItemCategories.Attach(entity);
			entity = context.ProductItemCategories.Remove(entity);
			if (AutoSave)
		...
		public override ProductItemCategory Delete(int key)
		{
		...
		public override async Task<ProductItemCategory> DeleteAsync(int key)
		{
			var entity = FindById(key);
			if (entity!=null)
				entity = context.ProductItemCategories.Remove(entity);
		...
		public override async Task<ProductItemCategory> UpdateAsync(ProductItemCategory entity)
		{
			entity = context.ProductItemCategories.Attach(entity);
			context.Entry(entity).State = EntityState.Modified;
			if (AutoSave)
