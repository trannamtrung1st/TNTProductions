...
namespace DataServiceTest.Models.Repositories
{
	...
	public partial class InventoryReceiptItemRepository : BaseRepository<InventoryReceiptItem, InventoryReceiptItemPK>, IInventoryReceiptItemRepository
	{
		...
		public override InventoryReceiptItem Remove(InventoryReceiptItem entity)
		{
		...
		public override InventoryReceiptItem Remove(InventoryReceiptItemPK key)
		{
		...
		public override IEnumerable<InventoryReceiptItem> RemoveIf(Expression<Func<InventoryReceiptItem, bool>> expr)
		{
			return context.InventoryReceiptItems.RemoveRange(GetActive(expr).ToList());
		}
		
		public override IEnumerable<InventoryReceiptItem> RemoveRange(IEnumerable<InventoryReceiptItem> list)
		{
			return context.InventoryReceiptItems.RemoveRange(list);
		}
