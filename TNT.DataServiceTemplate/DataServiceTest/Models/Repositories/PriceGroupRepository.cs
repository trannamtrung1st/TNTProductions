...
namespace DataServiceTest.Models.Repositories
{
	...
	public partial class PriceGroupRepository : BaseRepository<PriceGroup, int>, IPriceGroupRepository
	{
		...
		public override async Task<PriceGroup> AddAsync(PriceGroup entity)
		{
		...
		public override PriceGroup Delete(PriceGroup entity)
		{
		...
		public override async Task<PriceGroup> DeleteAsync(PriceGroup entity)
		{
			context.PriceGroups.Attach(entity);
			entity = context.PriceGroups.Remove(entity);
			if (AutoSave)
		...
		public override PriceGroup Delete(int key)
		{
		...
		public override async Task<PriceGroup> DeleteAsync(int key)
		{
			var entity = FindById(key);
			if (entity!=null)
				entity = context.PriceGroups.Remove(entity);
		...
		public override async Task<PriceGroup> UpdateAsync(PriceGroup entity)
		{
			entity = context.PriceGroups.Attach(entity);
			context.Entry(entity).State = EntityState.Modified;
			if (AutoSave)
