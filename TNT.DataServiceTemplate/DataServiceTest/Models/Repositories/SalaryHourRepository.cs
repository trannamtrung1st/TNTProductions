...
namespace DataServiceTest.Models.Repositories
{
	...
	public partial class SalaryHourRepository : BaseRepository<SalaryHour, int>, ISalaryHourRepository
	{
		...
		public override async Task<SalaryHour> AddAsync(SalaryHour entity)
		{
			entity.Active = true;
			entity = context.SalaryHours.Add(entity);
			if (AutoSave)
		...
		public override SalaryHour Delete(SalaryHour entity)
		{
		...
		public override async Task<SalaryHour> DeleteAsync(SalaryHour entity)
		{
			context.SalaryHours.Attach(entity);
			entity = context.SalaryHours.Remove(entity);
			if (AutoSave)
		...
		public override SalaryHour Delete(int key)
		{
		...
		public override async Task<SalaryHour> DeleteAsync(int key)
		{
			var entity = FindById(key);
			if (entity!=null)
				entity = context.SalaryHours.Remove(entity);
		...
		public override async Task<SalaryHour> UpdateAsync(SalaryHour entity)
		{
			entity = context.SalaryHours.Attach(entity);
			context.Entry(entity).State = EntityState.Modified;
			if (AutoSave)
