...
namespace DataServiceTest.Models.Repositories
{
	...
	public partial class AspNetUserRepository : BaseRepository<AspNetUser, string>, IAspNetUserRepository
	{
		...
		public override async Task<AspNetUser> AddAsync(AspNetUser entity)
		{
		...
		public override AspNetUser Delete(AspNetUser entity)
		{
		...
		public override async Task<AspNetUser> DeleteAsync(AspNetUser entity)
		{
			context.AspNetUsers.Attach(entity);
			entity = context.AspNetUsers.Remove(entity);
			if (AutoSave)
		...
		public override AspNetUser Delete(string key)
		{
		...
		public override async Task<AspNetUser> DeleteAsync(string key)
		{
			var entity = FindById(key);
			if (entity!=null)
				entity = context.AspNetUsers.Remove(entity);
		...
		public override async Task<AspNetUser> UpdateAsync(AspNetUser entity)
		{
			entity = context.AspNetUsers.Attach(entity);
			context.Entry(entity).State = EntityState.Modified;
			if (AutoSave)
