...
namespace DataServiceTest.Models.Repositories
{
	...
	public partial class EmployeeGroupRepository : BaseRepository<EmployeeGroup, int>, IEmployeeGroupRepository
	{
		...
		public override async Task<EmployeeGroup> AddAsync(EmployeeGroup entity)
		{
			entity.Active = true;
			entity = context.EmployeeGroups.Add(entity);
			if (AutoSave)
		...
		public override EmployeeGroup Delete(EmployeeGroup entity)
		{
		...
		public override async Task<EmployeeGroup> DeleteAsync(EmployeeGroup entity)
		{
			context.EmployeeGroups.Attach(entity);
			entity = context.EmployeeGroups.Remove(entity);
			if (AutoSave)
		...
		public override EmployeeGroup Delete(int key)
		{
		...
		public override async Task<EmployeeGroup> DeleteAsync(int key)
		{
			var entity = FindById(key);
			if (entity!=null)
				entity = context.EmployeeGroups.Remove(entity);
		...
		public override async Task<EmployeeGroup> UpdateAsync(EmployeeGroup entity)
		{
			entity = context.EmployeeGroups.Attach(entity);
			context.Entry(entity).State = EntityState.Modified;
			if (AutoSave)
