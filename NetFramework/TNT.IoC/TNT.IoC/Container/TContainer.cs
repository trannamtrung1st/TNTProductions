...
namespace TNT.IoC.Container
{
    ...
    public interface ITContainer : IDisposable
    {
        ...
        void AttachToRequestScope(HttpApplication context);
    }
    ...
    public partial class TContainer : ITContainer
    {
        ...
        public void AttachToRequestScope(HttpApplication context)
        {
            context.BeginRequest += (a, b) => HttpContext.Current.Items[TContainer.ContextKey] = this.CreateScope();
