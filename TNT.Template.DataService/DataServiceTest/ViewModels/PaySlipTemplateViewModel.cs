...
namespace DataServiceTest.ViewModels
{
	public partial class PaySlipTemplateViewModel: BaseViewModel<PaySlipTemplate>
	{
		...
		//[JsonProperty("payroll_periods")]
		//public IEnumerable<PayrollPeriodViewModel> PayrollPeriodsVM { get; set; }
		//[JsonProperty("template_detail_mappings")]
		//public IEnumerable<TemplateDetailMappingViewModel> TemplateDetailMappingsVM { get; set; }
		//[JsonProperty("template_rule_mappings")]
		//public IEnumerable<TemplateRuleMappingViewModel> TemplateRuleMappingsVM { get; set; }
