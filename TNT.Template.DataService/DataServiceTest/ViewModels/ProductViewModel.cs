...
namespace DataServiceTest.ViewModels
{
	public partial class ProductViewModel: BaseViewModel<Product>
	{
		...
		[JsonProperty("is_default_child_product")]
		...
		//[JsonProperty("customer_product_mappings")]
		//public IEnumerable<CustomerProductMappingViewModel> CustomerProductMappingsVM { get; set; }
		//[JsonProperty("date_products")]
		//public IEnumerable<DateProductViewModel> DateProductsVM { get; set; }
		//[JsonProperty("favoriteds")]
		//public IEnumerable<FavoritedViewModel> FavoritedsVM { get; set; }
		//[JsonProperty("order_details")]
		//public IEnumerable<OrderDetailViewModel> OrderDetailsVM { get; set; }
		//[JsonProperty("product_item_composition_mappings")]
		//public IEnumerable<ProductItemCompositionMappingViewModel> ProductItemCompositionMappingsVM { get; set; }
		//[JsonProperty("product_combo_details")]
		//public IEnumerable<ProductComboDetailViewModel> ProductComboDetailsVM { get; set; }
		//[JsonProperty("product_combo_details1")]
		//public IEnumerable<ProductComboDetailViewModel> ProductComboDetails1VM { get; set; }
		...
		//public IEnumerable<ProductImageViewModel> ProductImagesVM { get; set; }
		//[JsonProperty("product_specifications")]
		//public IEnumerable<ProductSpecificationViewModel> ProductSpecificationsVM { get; set; }
		//[JsonProperty("rating_products")]
		//public IEnumerable<RatingProductViewModel> RatingProductsVM { get; set; }
		//[JsonProperty("rating_stars")]
		//public IEnumerable<RatingStarViewModel> RatingStarsVM { get; set; }
