...
namespace DataServiceTest.ViewModels
{
	public partial class EmployeeGroupViewModel: BaseViewModel<EmployeeGroup>
	{
		...
		[JsonProperty("group_policy")]
		public Nullable<int> GroupPolicy { get; set; }
		[JsonProperty("group_security")]
		public Nullable<int> GroupSecurity { get; set; }
		//[JsonProperty("employees")]
		//public IEnumerable<EmployeeViewModel> EmployeesVM { get; set; }
		//[JsonProperty("time_frames")]
		//public IEnumerable<TimeFrameViewModel> TimeFramesVM { get; set; }
