...
namespace DataServiceTest.ViewModels
{
	public partial class ProductImageCollectionViewModel: BaseViewModel<ProductImageCollection>
	{
		...
		//[JsonProperty("product_image_collection_item_mappings")]
		//public IEnumerable<ProductImageCollectionItemMappingViewModel> ProductImageCollectionItemMappingsVM { get; set; }
