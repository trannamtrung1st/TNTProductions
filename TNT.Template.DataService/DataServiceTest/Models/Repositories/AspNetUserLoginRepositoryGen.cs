...
namespace DataServiceTest.Models.Repositories
{
	...
	public partial class AspNetUserLoginRepository : BaseRepository<AspNetUserLogin, AspNetUserLoginPK>, IAspNetUserLoginRepository
	{
		...
		public override AspNetUserLogin Remove(AspNetUserLogin entity)
		{
		...
		public override AspNetUserLogin Remove(AspNetUserLoginPK key)
		{
		...
		public override IEnumerable<AspNetUserLogin> RemoveIf(Expression<Func<AspNetUserLogin, bool>> expr)
		{
			return context.AspNetUserLogins.RemoveRange(GetActive(expr).ToList());
		}
		
		public override IEnumerable<AspNetUserLogin> RemoveRange(IEnumerable<AspNetUserLogin> list)
		{
			return context.AspNetUserLogins.RemoveRange(list);
		}
