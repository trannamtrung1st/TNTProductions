...
namespace DataServiceTest.Models.Repositories
{
	...
	public partial class ThemeRepository : BaseRepository<Theme, int>, IThemeRepository
	{
		...
		public override Theme Remove(Theme entity)
		{
		...
		public override Theme Remove(int key)
		{
		...
		public override IEnumerable<Theme> RemoveIf(Expression<Func<Theme, bool>> expr)
		{
			return context.Themes.RemoveRange(GetActive(expr).ToList());
		}
		
		public override IEnumerable<Theme> RemoveRange(IEnumerable<Theme> list)
		{
			return context.Themes.RemoveRange(list);
		}
