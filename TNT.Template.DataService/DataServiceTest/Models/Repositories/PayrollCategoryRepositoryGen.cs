...
namespace DataServiceTest.Models.Repositories
{
	...
	public partial class PayrollCategoryRepository : BaseRepository<PayrollCategory, int>, IPayrollCategoryRepository
	{
		...
		public override PayrollCategory Remove(PayrollCategory entity)
		{
		...
		public override PayrollCategory Remove(int key)
		{
		...
		public override IEnumerable<PayrollCategory> RemoveIf(Expression<Func<PayrollCategory, bool>> expr)
		{
			return context.PayrollCategories.RemoveRange(GetActive(expr).ToList());
		}
		
		public override IEnumerable<PayrollCategory> RemoveRange(IEnumerable<PayrollCategory> list)
		{
			return context.PayrollCategories.RemoveRange(list);
		}
