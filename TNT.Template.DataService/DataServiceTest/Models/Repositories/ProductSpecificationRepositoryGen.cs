...
namespace DataServiceTest.Models.Repositories
{
	...
	public partial class ProductSpecificationRepository : BaseRepository<ProductSpecification, int>, IProductSpecificationRepository
	{
		...
		public override ProductSpecification Remove(ProductSpecification entity)
		{
		...
		public override ProductSpecification Remove(int key)
		{
		...
		public override IEnumerable<ProductSpecification> RemoveIf(Expression<Func<ProductSpecification, bool>> expr)
		{
			return context.ProductSpecifications.RemoveRange(GetActive(expr).ToList());
		}
		
		public override IEnumerable<ProductSpecification> RemoveRange(IEnumerable<ProductSpecification> list)
		{
			return context.ProductSpecifications.RemoveRange(list);
		}
