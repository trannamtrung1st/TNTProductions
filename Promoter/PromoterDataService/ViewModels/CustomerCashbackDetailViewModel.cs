...
{
	public partial class CustomerCashbackDetailViewModel: BaseViewModel<CustomerCashbackDetail>
	{
		[JsonProperty("id")]
		...
		public CustomerCashbackDetailViewModel(CustomerCashbackDetail entity) : this()
		{
			FromEntity(entity);
		}
		
		public CustomerCashbackDetailViewModel()
		{
