...
namespace Hook
{
    public class CustomMouseEventArgs : MouseEventArgs
    {
        ...
        public CustomMouseEventArgs(bool mouseUp, MouseButtons button, int clicks, int x, int y, int delta) : base(button, clicks, x, y, delta)
        {
    ...
    public class UserActivityHook
    {
        ...
        public delegate void CustomMouseEventHandler(object sender, CustomMouseEventArgs args);
        ...
        private int MouseHookProc(int nCode, int wParam, IntPtr lParam)
        {
            ...
            if ((nCode >= 0) && (OnMouseActivity != null))
            {
                ...
                //generate event
                CustomMouseEventArgs e = new CustomMouseEventArgs(
                    mouseUp,
                    button,
                    clickCount,
