...
{
	public partial interface I.AspNetRolesRepository : IBaseRepository<.AspNetRoles, string>
	{
	}
	
	public partial class .AspNetRolesRepository : BaseRepository<.AspNetRoles, string>, I.AspNetRolesRepository
	{
		...
		{
			var result = await context.Database.ExecuteSqlCommandAsync("DELETE FROM .AspNetRoles");
			return result;
		}
