...
{
	public partial interface I.SeoKeywordsRepository : IBaseRepository<.SeoKeywords, string>
	{
	}
	
	public partial class .SeoKeywordsRepository : BaseRepository<.SeoKeywords, string>, I.SeoKeywordsRepository
	{
