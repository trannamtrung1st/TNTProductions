...
{
	public partial interface I.AspNetUsersRepository : IBaseRepository<.AspNetUsers, string>
	{
	}
	
	public partial class .AspNetUsersRepository : BaseRepository<.AspNetUsers, string>, I.AspNetUsersRepository
	{
